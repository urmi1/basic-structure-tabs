...
+(NSString*)toHexString{
    const CGFloat *components = CGColorGetComponents(((UIColor*)self).CGColor);
    int r = (int)(255.0 * components[0]);
    int g = (int)(255.0 * components[1]);
    int b = (int)(255.0 * components[2]);
    int a = (int)(255.0 * components[3]);
